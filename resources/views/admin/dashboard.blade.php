...
@section('admin_content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-4
                    hover:-translate-y-1 hover:shadow-md transition-all duration-200 group relative overflow-hidden">
            <div class="absolute -top-6 -right-6 w-24 h-24 rounded-full bg-sky-500/5 group-hover:bg-sky-500/10 transition-colors"></div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-4
                    hover:-translate-y-1 hover:shadow-md transition-all duration-200 group relative overflow-hidden">
            <div class="absolute -top-6 -right-6 w-24 h-24 rounded-full bg-emerald-500/5 group-hover:bg-emerald-500/10 transition-colors"></div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-4
                    hover:-translate-y-1 hover:shadow-md transition-all duration-200 group relative overflow-hidden">
            <div class="absolute -top-6 -right-6 w-24 h-24 rounded-full bg-violet-500/5 group-hover:bg-violet-500/10 transition-colors"></div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-4
                    hover:-translate-y-1 hover:shadow-md transition-all duration-200 group relative overflow-hidden">
            <div class="absolute -top-6 -right-6 w-24 h-24 rounded-full bg-maroon-700/5 group-hover:bg-maroon-700/10 transition-colors"></div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <h2 class="text-sm font-bold text-gray-800 uppercase tracking-wide">Academic &amp; Class Overview</h2>
                </div>
                <div class="p-6">
                    <p class="text-sm text-gray-500 leading-relaxed mb-5">
                        Welcome, <strong class="text-gray-700">{{ auth()->user()->name }}</strong>! You are administering the
                        WMSU Task Assignment &amp; Monitoring System. Use the shortcuts below to get started.
                    </p>
